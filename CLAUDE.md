...
**YOU ARE IN: `rabbit_game/polecats/rust/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/rabbit_game/` (rig root) or other directories
...
**Your mail address:** `rabbit_game/polecats/rust`
**Your rig:** rabbit_game
**Your Witness:** `rabbit_game/witness`
...
| Ask Witness for help | `gt mail send rabbit_game/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`rabbit_game/witness`) when:
...
```bash
gt mail send rabbit_game/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
